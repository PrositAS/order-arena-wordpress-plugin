...
Set the color scheme in the Order Arena Settings page.
You can select different color schemes for primary, accent and warn colors (along with contrasts).

= Image headers are not showing =

Set the image headers in the Order Arena Settings page. You can select from images uploaded to your WordPress media library or enter a URL to an image. The image will be displayed on the predefined pages.

Panoramic images are recommended, if you have an image with a different aspect ratio, it's recommended to crop it to more of a panoramic type.
