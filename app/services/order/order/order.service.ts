...
export class OrderService {
  ...
  completeOrder(orderRequestData: OrderFormPostData): Observable<OrderRequest> {
    if (orderRequestData) {
      this.bs.emit(EVENTS.ORDER_REQUEST_SENT, () => orderRequestData);
        ...
        .pipe(
          ...
          tap((orderRequest: OrderRequest) => {
            if (orderRequest) {
              ...
              this.bs.emit(EVENTS.ORDER_REQUEST_COMPLETED, () => orderRequest);
            } else {
              this.bs.emit(EVENTS.ORDER_REQUEST_FAILED, () => orderRequest);
